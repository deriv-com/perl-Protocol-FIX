...
subtest "component accessor" => sub {
    ...
    my $c = Protocol::FIX::Component->new('Credentials', [$f1 => 0, $f2 => 0]);
...
subtest "group accessor" => sub {
    ...
    my $g = Protocol::FIX::Group->new( $f0, [$f1 => 0, $f2 => 0]);
    my @tag_accessors = map {
        Protocol::FIX::TagsAccessor->new([
            $f1 => $_->[0],
            $f2 => $_->[1],
        ]);
    } ( [qw/my-login my-secret/], [qw/your-login your-secret/] );
