...
subtest "Logon Message serialization" => sub {
    my $buff = $proto->serialize_message('Logon' => [
        SenderCompID  => 'me',
        TargetCompID  => 'you',
        MsgSeqNum     => 1,
    ...
    is humanize($buff),
        '8=FIX.4.4 | 9=56 | 35=A | 49=me | 56=you | 34=1 | 52=20090107-18:15:16 | 98=0 | 108=60 | 10=110 | ';
};

subtest "Advertisement Message serialization (i.e. with component)" => sub {
    my $buff = $proto->serialize_message('Advertisement' => [
        SenderCompID  => 'me',
        TargetCompID  => 'you',
        MsgSeqNum     => 1,
        SendingTime   => '20090107-18:15:16',
...
subtest "missing mandatory fields" => sub {
    ...
    }, qr/'SenderCompID' is mandatory for message 'Logon'/,
    "missing mandatory field in head";
    ...
    }, qr/'HeartBtInt' is mandatory for message 'Logon'/,
    "missing mandatory field in body";

    like exception {
        $proto->serialize_message('Advertisement' => [
            SenderCompID  => 'me',
            TargetCompID  => 'you',
            MsgSeqNum     => 1,
            SendingTime   => '20090107-18:15:16',
    ...
    }, qr/'Instrument' is mandatory for message 'Advertisement'/,
    "missing mandatory component in body";
};
...
subtest "trying to add field, which is n/a for particular message" => sub {
    ...
    }, qr/Composite 'AdvId' is not available for message 'Logon'/,
    "dies with explanation";
};
